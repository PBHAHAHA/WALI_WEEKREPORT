  ...
  <div class="min-h-screen flex items-center justify-center bg-gray-50">
    <div class="w-full max-w-md p-8 bg-white rounded-2xl shadow-sm border border-gray-100">
      <div class="text-center mb-8">
        <h1 class="text-2xl font-semibold text-gray-900 mb-2">创建账户</h1>
        <p class="text-gray-500">注册周报系统账户</p>
      </div>
        ...
        <div>
          ...
          <div class="flex gap-3">
            ...
            <button
              ...
              class="px-4 py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
            >
...
const { sendCode, register, isLoggedIn } = useAuth()
...
const handleRegister = async () => {
  ...
  try {
    await register(form.email, form.password, form.code, form.nickname)
